...
class ConjureSpell : public InstantSpell
{
	public:
		...
		virtual bool castSpell(Creature* creature) {return NULL;}
		virtual bool castSpell(Creature* creature, Creature* target) {return NULL;}
...
class RuneSpell : public Action, public Spell
{
	public:
		...
		virtual bool isInstant() const {return NULL;}
