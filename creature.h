...
class Creature : public AutoId, virtual public Thing
{
	...
	public:
		...
		virtual bool canSeeInvisibility() const {return NULL;}
		...
		virtual bool isGhost() const {return NULL;}
		virtual bool isWalkable() const {return NULL;}
		...
		virtual bool isAccountManager() const {return NULL;}
		...
		virtual bool challengeCreature(Creature* creature) {return NULL;}
		virtual bool convinceCreature(Creature* creature) {return NULL;}
		...
		virtual bool getCombatValues(int32_t& min, int32_t& max) {return NULL;}
	...
	protected:
		...
		virtual bool useCacheMap() const {return NULL;}
		...
		virtual bool hasExtraSwing() {return NULL;}
