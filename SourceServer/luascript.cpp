...
void LuaScriptInterface::registerFunctions()
{
	...
	//doCloneItemEx(itemid[, count/subType = -1])
	lua_register(m_luaState, "doCloneItemEx", LuaScriptInterface::luaDoCloneItemEx);
...
int32_t LuaScriptInterface::luaDoCloneItemEx(lua_State* L)
{
    //doCloneItemEx(uid)
    ScriptEnviroment* env = getEnv();
    Item* item = env->getItemByUID(popNumber(L));
